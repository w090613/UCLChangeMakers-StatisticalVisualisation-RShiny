...
server <- function(input, output, session){
  ...
  population <- reactive({ #executes the code inside {} and render data to population object
    if (input$dist == "norm") {rnorm(input$pop_size)}
    else if (input$dist == "unif") {runif(input$pop_size)}
    else if (input$dist == "exp") {rexp(input$pop_size)}
    else if (input$dist == "binom") {rbinom(input$pop_size)}
    else if (input$dist == "nbinom") {rnbinom(input$pop_size)}
    else if (input$dist == "pois") {rpois(input$pop_size)}
    else if (input$dist == "geom") {rgeom(input$pop_size)}
    else if (input$dist == "hyper") {rhyper(input$pop_size)}
    else if (input$dist == "chisq") {rchisq(input$pop_size)}
    else if (input$dist == "t") {rt(input$pop_size)}
    else if (input$dist == "beta") {rbeta(input$pop_size)}
    else if (input$dist == "gamma") {rgamma(input$pop_size)}
